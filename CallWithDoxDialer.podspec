#
#  Be sure to run `pod spec lint CallWithDoxDialer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors            = { "Atai Barkai" => "atai.barkai@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/doximity/CallWithDoxDialer.git", :tag => "#{s.version}" }
